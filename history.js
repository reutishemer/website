...
document.addEventListener('DOMContentLoaded', () => {
  initScrollChevronHis();
});

/* ─────────────────────────────────────────
   history — Scroll Chevron
───────────────────────────────────────── */
function initScrollChevronHis() {
  const chevron = document.getElementById('scrollChevronHis');
  console.log("in chevron");
  if (!chevron) {
    console.log("didnt find any chevron");
    return;
  }
//   chevron.addEventListener('click', () => {
//     const container = document.querySelector('.scroll-snap-container-his');
//     const target    = document.querySelector('.wof-section');
